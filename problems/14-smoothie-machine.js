...
function smoothieMachine(...initialIngredients) {
  const allIngredients = [...initialIngredients];
...
// This function doesn't maintain all the ingredients from the previous subsequent calls
// function smoothieMachine(...initialIngredients) {
//   return function(...newIngredients) {
//     let wordArr = [...initialIngredients, ...newIngredients];
